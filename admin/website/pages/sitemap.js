                        ...
                        <div className="sitemap-form-container">
                            <div className="sitemap-form-section">
                                ...
                                <div className="sitemap-form-description">
                                    <span>This will write new content to the sitemap.xml file hosted by the frontend website.</span>
                                </div>
                            ...
                            <div className="sitemap-form-section">
                                ...
                                <div className="sitemap-form-description">
                                    <span>This will ping Google and Bind to let them know updates to the sitemap</span>
                                </div>
                                <div className="sitemap-form-btn-container">
                                    {
